...
export default function Footer() {
    return (
        <footer>
            <div className='svg-links center-inline'>
                <a href='mailto:mnsrt342@gmail.com' aria-label="Contact me via email">
                ...
                <a href='https://github.com/mnsrt-pb' aria-label="Visit my github">
                ...
                <a href='https://mnsrt-pb.github.io/' aria-label="Visit my personal website">
